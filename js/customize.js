...
$(function () {
  ...
  $('.scrollDownbtn01').click(function () {
    $('body,html')
      .stop(true, true)
      .animate({ scrollTop: $('.mpdata').offset().top - 110 }, 0, 'easeOutExpo');
  });
  $('.scrollDownbtn02').click(function () {
    $('body,html')
      .stop(true, true)
      .animate({ scrollTop: $('.publications_block').offset().top - 90 }, 0, 'easeOutExpo');
  });
  $('.scrollDownbtn03').click(function () {
    $('body,html')
      .stop(true, true)
      .animate({ scrollTop: $('.hot_movie_block').offset().top - 90 }, 0, 'easeOutExpo');
  });
  // 收合書目table
  ...
  $('.bibliography_block .collapse_btn').on('keydown', function (event) {
    if (event.keyCode === 13) {
      $(this).next('.bibliography').slideToggle();
      $(this).toggleClass('closebtn');
    }
  ...
  $('.bibliography_block2 .collapse_btn').on('keydown', function (event) {
    if (event.keyCode === 13) {
      $(this).next('.bibliography').slideToggle();
      $(this).toggleClass('closebtn');
      $(this).parents('.list_file').siblings().find('.bibliography').slideUp();
  ...
  _vBox.hover(
    ...
    function () {
      ...
      setTimeout(function () {
        _videofuncIcons.removeAttr('style');
      }, 310);
    }
  );
